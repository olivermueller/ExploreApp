...
class FTPConnect: UIViewController, FileProviderDelegate {
...
//        webdav = WebDAVFileProvider(baseURL: server, credential: credential)!
    ...
    @IBAction func createFile(_ sender: Any) {
        ...
        webdav?.writeContents(path: "sample.txt", contents: data, atomically: true, overwrite: true, completionHandler: nil)
    }
